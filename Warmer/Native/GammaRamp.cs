...
{
    /**
     * Following source code was taken from the file colorramp.c of the Redshift project:
     * https://github.com/jonls/redshift/blob/master/src/colorramp.c
     *
     * Content was modified a bit (And adapter to C#), and since I'm not quite sure how the
     * licenses work, I don't know exactly what I am supposed to do. If there is some kind of
     * problem with this, then please feel free to tell me so.
     */

    /// <summary>
    /// Represents a gamma ramp that can be passed to SetDeviceGammaRamp
    /// </summary>
    ...
    public struct GammaRamp
    {
        ...
        /// <param name="white_point"></param>
        /// <returns></returns>
        private static ushort GetValue(double gamma, double white_point)
        {
            return (ushort)(gamma / kUshortMax * white_point * kUshortMax);
        }
        ...
        /// <param name="c2"></param>
        /// <returns></returns>
        private static double[] InterpolateColor(double alpha, int c1, int c2)
        {
            var white_point = new double[3];

            white_point[0] = (1.0f - alpha) * kBlackBodyColor[c1] + alpha * kBlackBodyColor[c2];
            white_point[1] = (1.0f - alpha) * kBlackBodyColor[c1 + 1] + alpha * kBlackBodyColor[c2 + 1];
            white_point[2] = (1.0f - alpha) * kBlackBodyColor[c1 + 2] + alpha * kBlackBodyColor[c2 + 2];
        ...
        /// Gamma ramp size
        /// </summary>
        private const int kGammaRampSize = 256;

        /// <summary>
        /// Maximum ushort value
        /// </summary>
        private const int kUshortMax = ushort.MaxValue + 1;

        /// <summary>
        /// ???
        /// </summary>
        private static double[] kBlackBodyColor = {
